    ...
    <main className="grid min-h-screen bg-background lg:grid-cols-[0.95fr_1fr]">
      <section className="hidden border-r border-border bg-card px-10 py-12 lg:flex lg:flex-col lg:justify-between">
        ...
        <div className="max-w-md">
          ...
          <h1 className="mt-4 text-4xl font-semibold tracking-tight">Manage invoices, expenses, and business finances from one place.</h1>
          <p className="mt-5 text-base leading-7 text-muted-foreground">A clean workspace for creating documents, reviewing AI drafts, tracking usage, and understanding financial progress.</p>
        </div>
      </section>
